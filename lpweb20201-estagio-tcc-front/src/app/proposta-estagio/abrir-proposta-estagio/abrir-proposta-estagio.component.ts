...
@Component({
  selector: 'app-abrir-proposta-estagio',
  templateUrl: './abrir-proposta-estagio.component.html',
  styleUrls: ['./abrir-proposta-estagio.component.css'],
})

export class AbrirPropostaEstagioComponent implements OnInit {
  proposta: any;
